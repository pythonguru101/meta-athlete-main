...
declare module '@polkadot/types/lookup' {
  ...
  export interface MetaAthletePrimitivesBirthplace extends Struct {
    readonly birthplace: Bytes;
  }

  /** @name MetaAthletePrimitivesSchoolgrade (6) */
  export interface MetaAthletePrimitivesSchoolgrade extends Struct {
    readonly schoolgrade: Bytes;
  }
